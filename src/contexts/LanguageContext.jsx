...
const translations = {
  el: {
    ...
    researchText2: 'Οι κλίμακες αυτές μπορούν να χρησιμοποιηθούν τόσο για την ανάπτυξη υπηρεσιών ψυχικής υγείας σε ευρύτερο πεδίο όσο και στην αξιολόγηση των θεραπευτικών μεθόδων.',
    ...
    parentCounselingDesc: 'Συμβουλευτική και υποστήριξη γονέων / οικογενειακή θεραπεία.',
  ...
  en: {
    ...
    welcomeText: 'The Institute of Modern Pedagogy was founded in 1986 and operates as a day care center for people with special needs. We provide specialized therapeutic services for individuals with mental disabilities, aiming to develop their skills and social integration.',
    ...
    researchText1: 'In collaboration with the Research and Academic Institute of Athens, we work on developing evaluation scales and measurement scales for the results of therapeutic applications.',
    researchText2: 'These scales can be used both for the development of mental health services in a broader field and for the evaluation of their therapeutic methods.',
    ...
    behavioralDisordersDesc: 'Behavioral and emotional disorders of childhood.',
    adhd: 'ADHD',
