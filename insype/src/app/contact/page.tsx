        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              and how we can help your child.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">210-2281031</p>
                  </div>
                </div>
              </motion.div>
            ...
            <motion.div
              ...
              className="glass-card p-6"
            >
              <h3 className="text-xl font-semibold text-white mb-4">Public Transportation</h3>
              <div className="space-y-2 text-gray-300">
                <p><strong>Metro:</strong> 'Omonia' Station</p>
                <p><strong>Lines:</strong> 605, 18, 88</p>
                <p><strong>Bus Stop:</strong> St. Athens</p>
                <p><strong>Lines:</strong> 5, 13</p>
                <p><strong>Area:</strong> Omonia</p>
              </div>
            </motion.div>
          </motion.div>
